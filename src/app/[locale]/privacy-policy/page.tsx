...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Privacy Policy - Knife Duels Wiki',
    description: 'Knife Duels Wiki Privacy Policy. Learn how we collect, use, and protect your data when you use our Roblox knife combat resource platform. Your privacy matters to us.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              Knife Duels Wiki (&quot;we&quot;, &quot;our&quot;, or &quot;us&quot;) collects minimal information to provide and improve our services.
            ...
            <h2>11. Disclaimer</h2>
            <p>
              Knife Duels Wiki is an unofficial fan-made website and is not affiliated with, endorsed by, or associated
              with Roblox Corporation or the developers of Knife Duels. All game content, trademarks, and assets are
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:privacy@knife-duels.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">privacy@knife-duels.wiki</a>
            </p>
            <p>
