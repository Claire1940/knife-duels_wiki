...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: "Terms of Service - Knife Duels Wiki",
    description: "Read the Terms of Service for Knife Duels Wiki. Learn about user responsibilities, content usage guidelines, and legal terms for using our Roblox knife combat resource platform.",
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: "Terms of Service - Knife Duels Wiki",
      description: "Terms and conditions for using Knife Duels Wiki.",
      images: [
        {
      ...
      <section className="relative py-20 px-4 border-b border-border">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-slate-300 text-lg mb-2">
            Terms and conditions for using Knife Duels Wiki
          </p>
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              By accessing and using Knife Duels Wiki (&quot;the Website&quot;, &quot;we&quot;, &quot;our&quot;, or &quot;us&quot;), you agree to be bound
              by these Terms of Service (&quot;Terms&quot;). If you do not agree to these Terms, please do not use our Website.
            </p>
            <p>
              These Terms constitute a legally binding agreement between you (&quot;User&quot;, &quot;you&quot;, or &quot;your&quot;) and Knife Duels Wiki.
              Your continued use of the Website signifies your acceptance of these Terms and any future modifications.
            </p>

            <h2>2. Description of Service</h2>
            <p>
              Knife Duels Wiki is an unofficial, community-driven fan website that provides information, guides, tools,
              and resources related to the Roblox game &quot;Knife Duels&quot;. Our services include, but are not limited to:
            </p>
            <ul>
              <li>Active codes and free reward guides</li>
              <li>Knife skin showcases and rarity guides</li>
              <li>Weapon stats and tier lists</li>
              <li>Controls and combat mechanics</li>
              <li>Game mode rules (1v1, Free For All, Team Duels)</li>
              <li>Duel strategies and tips</li>
            </ul>
            <p>
              <strong>Important:</strong> Knife Duels Wiki is NOT affiliated with, endorsed by, or associated with
              Roblox Corporation or the official developers of Knife Duels. We are an independent fan community.
            </p>
            ...
            <p>
              ...
              graphics, logos, images, and software) are owned by Knife Duels Wiki and are protected by international
              copyright, trademark, and other intellectual property laws.
            </p>

            <h3>4.2 Game Content</h3>
            <p>
              All game-related content, including but not limited to knife skins, game screenshots, logos, and
              trademarks, are the property of Roblox Corporation and/or the developers of Knife Duels. We use such
            ...
            <ul>
              <li><strong>Accuracy:</strong> We strive to provide accurate information, but we do not guarantee that all content is current, complete, or error-free. Game updates may render codes, skins, or strategies outdated.</li>
              ...
              <li><strong>Code Validity:</strong> redeemable codes may expire or change without notice. We are not responsible for invalid codes or changes to in-game rewards.</li>
            </ul>
            <p>
            ...
            <p>
              TO THE FULLEST EXTENT PERMITTED BY LAW, KNIFE DUELS WIKI SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL,
            ...
            <p>
              ...
              you and Knife Duels Wiki regarding the use of the Website and supersede any prior agreements or understandings.
            </p>
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:legal@knife-duels.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">legal@knife-duels.wiki</a>
            </p>
            <p>
